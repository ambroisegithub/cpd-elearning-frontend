...
export const selectIsUpdating = (state: RootState) => state.systemAdminUserManagement.isUpdating;
export const selectIsDeleting = (state: RootState) => state.systemAdminUserManagement.isDeleting;
export const selectSelectedUser = (state: RootState) => state.systemAdminUserManagement.selectedUser;
export const selectIsLoadingUser = (state: RootState) => state.systemAdminUserManagement.isLoadingUser;
export const selectUserError = (state: RootState) => state.systemAdminUserManagement.userError;
export const selectUsersError = (state: RootState) => state.systemAdminUserManagement.usersError;
export const selectIsLoadingStats = (state: RootState) => state.systemAdminUserManagement.isLoadingStats;
export const selectOperationSuccess = (state: RootState) => state.systemAdminUserManagement.operationSuccess;
export const selectOperationError = (state: RootState) => state.systemAdminUserManagement.operationError;
