    ...
    const messageListener = (event: MessageEvent) => {
      ...
      try {
        ...
        if (data.type === 'SSO_SUCCESS') {
          ...
          // Process SSO token
          if (data.token) {
            // Store token and trigger CPD eLearning authentication
...
/**
 * Handles SSO token from Ongera and exchanges it for CPD eLearning session
 */
...
/**
 * Logs out from all systems (CPD eLearning + Ongera)
 */
