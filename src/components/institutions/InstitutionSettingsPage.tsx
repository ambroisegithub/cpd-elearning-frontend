  ...
  const handleSaveGeneral = async () => {
    ...
    try {
      const authToken = token || (typeof window !== "undefined"
        ? document.cookie.match(/cpd_token=([^;]+)/)?.[1]
        : null);
        ...
        `${process.env.NEXT_PUBLIC_API_URL}/institutions/${institutionId}`,
        {
          ...
          body: JSON.stringify({
            settings: {
              ...
              require_approval_for_private:
                courseSettings.require_approval_for_private,
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    <Label>Require Private Course Approval</Label>
                    <p className="text-sm text-gray-500">
                      Require approval for Private course enrollments
                    </p>
                  </div>
                  <Switch
                    checked={courseSettings.require_approval_for_private}
                    onCheckedChange={(checked) =>
                      setCourseSettings({
                        ...courseSettings,
