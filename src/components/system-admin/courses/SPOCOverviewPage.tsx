...
export default function PrivateCoursesOverviewPage() {
  ...
  const fetchOverview = useCallback(async (page = 1) => {
    ...
    try {
      ...
      toast.error("Failed to load private course overview");
    } finally {
        ...
        <div className="flex items-center justify-between">
          <div>
            <div className="flex items-center gap-3 mb-1">
              ...
              <h1 className="text-2xl font-bold text-gray-900">Private Courses Overview</h1>
            </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="bg-white rounded-xl p-5 shadow-sm border border-gray-200">
              <div className="flex items-center justify-between mb-3">
                <span className="text-sm text-gray-500 font-medium">Total Private Courses</span>
