...
export default function PublicCoursesOverviewPage() {
  ...
  const fetchOverview = useCallback(async (page = 1) => {
    ...
    try {
      ...
      const res = await api.get(`/courses/admin/public-overview?${params.toString()}`);
      if (res.data.success) {
      ...
      toast.error("Failed to load Public overview");
    } finally {
        ...
        <div className="flex items-center justify-between">
          <div>
            <div className="flex items-center gap-3 mb-1">
              ...
              <h1 className="text-2xl font-bold text-gray-900">Public Overview</h1>
            </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="bg-white rounded-xl p-5 shadow-sm border border-gray-200">
              <div className="flex items-center justify-between mb-3">
                <span className="text-sm text-gray-500 font-medium">Total Publics</span>
            ...
            <div className="bg-white rounded-xl p-5 shadow-sm border border-gray-200">
              ...
              <p className="text-xs text-gray-400 mt-2">Across all Public courses</p>
            </div>
        ...
        {topCourses.length > 0 && (
          <div className="bg-white rounded-xl p-5 shadow-sm border border-gray-200">
            <h3 className="font-semibold text-gray-900 mb-4 flex items-center gap-2">
              ...
              Top Public Courses by Enrollment
            </h3>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
          ...
          {isLoading || overviewLoading ? (
            ...
            <div className="p-12 text-center">
              ...
              <p className="text-gray-500">No Public courses found</p>
            </div>
          ) : (
