...
export default function PrivateCoursesOverviewPage() {
  ...
  const fetchOverview = useCallback(async (page = 1) => {
    ...
    try {
      ...
      const res = await api.get(`/courses/admin/private-overview?${params.toString()}`);
      if (res.data.success) {
      ...
      toast.error("Failed to load Private overview");
    } finally {
        ...
        <div className="flex items-center justify-between">
          <div>
            <div className="flex items-center gap-3 mb-1">
              ...
              <h1 className="text-2xl font-bold text-gray-900">Private Overview</h1>
            </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="bg-white rounded-xl p-5 shadow-sm border border-gray-200">
              <div className="flex items-center justify-between mb-3">
                <span className="text-sm text-gray-500 font-medium">Total Privates</span>
            ...
            <div className="bg-white rounded-xl p-5 shadow-sm border border-gray-200">
              ...
              <p className="text-xs text-gray-400 mt-2">With Private courses</p>
            </div>
            ...
            <div className="bg-white rounded-xl p-5 shadow-sm border border-gray-200">
              ...
              <p className="text-xs text-gray-400 mt-2">Across all Private courses</p>
            </div>
          ...
          <div className="flex flex-col md:flex-row gap-3">
            <div className="flex-1 relative">
              ...
              <input
                ...
                placeholder="Search Private courses or institution name..."
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
          ...
          {overviewLoading ? (
            ...
            <div className="p-12 text-center">
              ...
              <p className="text-gray-500">No Private courses found</p>
            </div>
          ) : (
