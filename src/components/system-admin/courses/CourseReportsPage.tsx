            ...
            {activeTab === "overview" && (
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  <StatCard label="Total Courses" value={data.platform_stats.total_courses} sub={`${data.platform_stats.total_public} Public + ${data.platform_stats.total_private} Private`} icon={BookOpen} color="blue" />
                  ...
                  <div className="bg-white rounded-xl p-5 shadow-sm border border-gray-200">
                          ...
                          <div className="flex-1 flex gap-1">
                            <div className="flex-1 bg-gray-100 rounded h-2 relative">
                              <div
                                ...
                                style={{ width: `${maxCourseCount > 0 ? Math.round((t.public_count / maxCourseCount) * 100) : 0}%` }}
                              />
                            </div>
                            <div className="flex-1 bg-gray-100 rounded h-2 relative">
                              <div
                                className="h-2 rounded bg-purple-400"
                                style={{ width: `${maxCourseCount > 0 ? Math.round((t.private_count / maxCourseCount) * 100) : 0}%` }}
                              />
                            </div>
                          </div>
                    ...
                    <div className="flex items-center gap-4 mt-3 pt-3 border-t border-gray-100">
                      <span className="flex items-center gap-1.5 text-xs text-gray-500">
                        <span className="w-3 h-1.5 rounded bg-blue-400 inline-block" /> Public Course
                      </span>
                      <span className="flex items-center gap-1.5 text-xs text-gray-500">
                        <span className="w-3 h-1.5 rounded bg-purple-400 inline-block" /> Private Course
                      </span>
                    </div>
                  </div>
                      ...
                      {data.top_courses.map((course: any, i: number) => (
                        <tr key={course.id} className="hover:bg-gray-50 transition-colors">
                          ...
                          <td className="px-3 py-3 text-center">
                            <span className={`inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-xs font-medium ${course.course_type === "PUBLIC" ? "bg-blue-100 text-blue-800" : "bg-purple-100 text-purple-800"}`}>
                              {course.course_type === "PUBLIC" ? <Globe className="w-3 h-3" /> : <Lock className="w-3 h-3" />}
                              {course.course_type}
                            </span>
                          </td>
                          <td className="px-3 py-3 text-center">
