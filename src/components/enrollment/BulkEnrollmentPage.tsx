...
export default function BulkEnrollmentPage() {
  ...
  const handleGenerateAccessCodes = async () => {
    ...
    if (!selectedCourseData || selectedCourseData.course_type !== "PRIVATE") {
      toast.error("Access codes can only be generated for Private Course courses");
      return;
    }
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                {selectedCourseData?.course_type === "PRIVATE" && (
