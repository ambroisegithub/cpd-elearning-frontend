...
export default function CourseBasicInfoForm({
  ...
  const [formData, setFormData] = useState({
    ...
    course_type: course?.course_type || CourseType.PUBLIC,
...
{/* Course Type and Level */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2 w-full">
              ...
              >
                <option value={CourseType.PUBLIC}>Public Course</option>
                <option value={CourseType.PRIVATE}>Private Course (Access Code)</option>
              </select>
              <p className="text-xs text-muted-foreground italic">
                {formData.course_type === CourseType.PUBLIC
          ...
          {formData.course_type === CourseType.PRIVATE && (
          ...
          {/* Public Course and Certificate Settings */}
