    ...
    if (navigator.share) {
      try {
        await navigator.share({
          title: `Check out ${courseTitle} on CPD eLearning`,
          text: `I just published "${courseTitle}" on CPD eLearning!`,
          url: shareUrl,
        })
      } catch (error) {
          ...
          <Card className="relative overflow-hidden border border-gray-300 bg-white shadow-xl">
            ...
            <CardContent className="p-4 text-center space-y-6">
              ...
              <div className="space-y-3">
                ...
                >
                  {user?.cpd_role === "SYSTEM_ADMIN" ? "Course Published!" : "Course Submitted Successfully!"}
                </motion.h2>
                <motion.p
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
              ...
              >
                ...
                {courseId && user?.cpd_role === "SYSTEM_ADMIN" && (
                  <Button 
                    onClick={handleShare} 
                    variant="outline" 
                    size="lg"
