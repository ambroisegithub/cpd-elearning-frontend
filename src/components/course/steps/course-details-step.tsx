        ...
        >
          ...
          <div className="space-y-1.5">
            ...
            <RichTextEditor
              ...
              className="min-h-[200px] border border-gray-200 rounded-lg overflow-hidden text-sm"
              placeholder="Provide a comprehensive overview of your course, including key topics, learning outcomes, and what students will achieve..."
            />
          </div>
          ...
          <div className="space-y-1.5">
            ...
            <RichTextEditor
              ...
              className="min-h-[100px] border border-gray-200 rounded-lg overflow-hidden text-sm"
              placeholder="A compelling short description that appears in course listings and search results..."
            />
            <div className="flex justify-end">
              <span className="text-xs text-gray-400">
                {(courseData.short_description?.replace(/<[^>]*>/g, '').length || 0)} characters
              </span>
            </div>
          </div>
        </Section>
        ...
        >
          ...
          {isSystemAdmin && (
            <div className="space-y-1.5">
              ...
              <select
                id="course_type"
                value={courseData.course_type || "PUBLIC"}
                onChange={(e) => {
                ...
                className={sel}
              >
                <option value="PUBLIC">Public Course — Open to all learners</option>
                <option value="PRIVATE">Private Course — Requires access code</option>
              </select>
            </div>
          )}

          {/* Course Type — Institution Admin: selectable */}
          {isInstitutionAdmin && (
            <div className="space-y-1.5">
              <Label htmlFor="course_type_inst" className={lbl}>
                Course Type <span className="text-red-500">*</span>
              </Label>
              <select
                id="course_type_inst"
                value={courseData.course_type || "PRIVATE"}
                onChange={(e) => {
                  const value = e.target.value
                  const updates: any = { course_type: value }
                  if (value === "PUBLIC") {
                ...
                className={sel}
              >
                <option value="PUBLIC">Public Course — Open to institution members</option>
                <option value="PRIVATE">Private Course — Requires access code</option>
              </select>
          ...
          {(courseData.course_type === "PRIVATE" || isInstitutionAdmin) && (
            <div className="flex items-start gap-2.5 px-3 py-2.5 bg-purple-50 border border-purple-100 rounded-lg">
              ...
              <div className="text-xs text-purple-700 leading-snug space-y-0.5">
                <p className="font-semibold">Private Course — Access code required</p>
                <p>Requires access codes or institution membership to enroll.</p>
                {isInstitutionAdmin && (
                  <p className="text-purple-500">
                    Institution Admin: Can create both Public and Private courses for your institution.
                  </p>
                )}
                {isSystemAdmin && (
                  <p className="text-purple-500">
                    System Admin: Can create Private courses for any institution.
                  </p>
                )}
              </div>
            </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="space-y-1.5">
              <Label htmlFor="cpd_hours" className={lbl}>
                <span className="flex items-center gap-1.5">
                  <Award className="w-3.5 h-3.5 text-[#2D6A4F]" />
                  CPD Hours <span className="text-red-500">*</span>
                </span>
              </Label>
              <Input
                id="cpd_hours"
                ...
                step="0.5"
                placeholder="e.g. 2.5"
                value={courseData.cpd_hours || ""}
                onChange={(e) =>
                  setCourseData({
                    ...courseData,
                    cpd_hours: Number.parseFloat(e.target.value) || 0,
                  })
                }
                className={inp}
              />
              <p className="text-[10px] text-[#717182]">CPD hours awarded upon course completion</p>
            </div>
          </div>
