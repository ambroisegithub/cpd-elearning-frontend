...
const navigationItems: Record<CPDRole | "default", NavigationItem[]> = {
  [CPDRole.SYSTEM_ADMIN]: [
    ...
    },
    {
      ...
      children: [
        ...
        { name: "Private Courses", href: "/sys-admin/courses/private", icon: Lock },
  ...
  [CPDRole.INSTITUTION_ADMIN]: [
    { name: "Dashboard", href: "/institution-admin/dashboard", icon: Home },
    {
      ...
      children: [
        ...
        { name: "Private Courses", href: "/institution-admin/courses/private", icon: Lock },
...
const roleIcons: Record<CPDRole, any> = {
  [CPDRole.SYSTEM_ADMIN]: Server,
  [CPDRole.INSTITUTION_ADMIN]: Shield,
  [CPDRole.CONTENT_CREATOR]: UserRoundCheck,
  [CPDRole.INSTRUCTOR]: GraduationCap,
  [CPDRole.LEARNER]: Users,
}
...
export function Sidebar({ className }: SidebarProps) {
  ...
  const userRole = user?.cpd_role || CPDRole.LEARNER
        ...
        <div className="flex items-center justify-between p-6 border-b border-border">
          {!isCollapsed && (
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="font-bold text-text">CPD eLearning</h2>
                <p className="text-xs text-gray-500 capitalize font-medium">
                  {userRole === CPDRole.SYSTEM_ADMIN 
                    ? "System Admin" 
                    : userRole === CPDRole.INSTITUTION_ADMIN
                    ? "Institution Admin"
                    : userRole === CPDRole.CONTENT_CREATOR
                    ? "Content Creator"
                    : userRole === CPDRole.INSTRUCTOR
                    ? "Instructor"
                    : "Learner"}
                </p>
              </div>
