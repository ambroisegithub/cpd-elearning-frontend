...
export default function CoursesPage() {
        ...
        <div className="p-4 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl border border-blue-100">
          ...
          <div className="space-y-2 text-sm">
            {[
              ...
              { label: "Public Courses", count: courses.filter((c) => c.course_type === "PUBLIC").length, color: "bg-purple-600" },
              { label: "Private Courses", count: courses.filter((c) => c.course_type === "PRIVATE").length, color: "bg-indigo-600" },
  ...
  // Smart Transparent Skeleton for loading state
  const LoadingSkeleton = () => (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      ...
      <div className="flex mt-10 min-h-[calc(100vh-64px)]">
        ...
        <aside className="hidden lg:flex flex-col sticky top-16 h-[calc(100vh-4rem)] w-72 xl:w-80 bg-white/80 backdrop-blur-sm border-r border-gray-200/50 flex-shrink-0 overflow-hidden">
          <div className="p-5 space-y-6">
            {/* Search Skeleton */}
            <div>
              <Skeleton className="h-4 w-24 mb-2 bg-gray-200/70" />
              <Skeleton className="h-10 w-full rounded-lg bg-gray-200/70" />
            </div>
            {/* Category Skeleton */}
            <div>
              <Skeleton className="h-4 w-20 mb-2 bg-gray-200/70" />
              <Skeleton className="h-10 w-full rounded-lg bg-gray-200/70" />
            </div>
            {/* Level Skeleton */}
            <div>
              ...
              <div className="space-y-2">
                {[1, 2, 3, 4, 5].map((i) => (
                  <Skeleton key={i} className="h-12 w-full rounded-lg bg-gray-200/70" />
                ))}
              </div>
            </div>
            {/* Price Skeleton */}
            <div>
              <Skeleton className="h-4 w-16 mb-2 bg-gray-200/70" />
              <div className="space-y-2">
                {[1, 2, 3].map((i) => (
                  <Skeleton key={i} className="h-12 w-full rounded-lg bg-gray-200/70" />
                ))}
            ...
            {/* Stats Skeleton */}
            <Skeleton className="h-48 w-full rounded-xl bg-gray-200/70" />
          </div>
        </aside>
          ...
          <div className="text-center mb-8">
            <div className="py-8">
              <div className="flex items-center justify-center gap-3 mb-3">
                <Skeleton className="w-14 h-14 rounded-full bg-gray-200/70" />
                <Skeleton className="h-10 w-64 rounded-lg bg-gray-200/70" />
              </div>
              <Skeleton className="h-6 w-96 mx-auto rounded-lg bg-gray-200/70" />
            </div>
          </div>

          {/* Results Count Skeleton */}
          <div className="mb-5 flex items-center gap-3">
            <Skeleton className="h-8 w-32 rounded-full bg-gray-200/70" />
            <Skeleton className="h-4 w-24 rounded bg-gray-200/70" />
          </div>
              ...
              <div key={i} className="bg-white/80 backdrop-blur-sm rounded-xl border border-gray-200/50 overflow-hidden">
                ...
                <div className="p-4 space-y-3">
                  ...
                  <div className="flex flex-wrap gap-2">
                    ...
                    <Skeleton className="h-6 w-14 rounded-full bg-gray-200/70" />
                  </div>
                  {/* Stats Skeleton */}
                  ...
                  {/* Button Skeleton */}
                  <Skeleton className="h-10 w-full rounded-lg bg-gray-200/70 mt-2" />
                </div>
              </div>
            ))}
          </div>
