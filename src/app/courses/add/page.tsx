  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        if (user.cpd_role === "SYSTEM_ADMIN" || user.cpd_role === "INSTITUTION_ADMIN") {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const courseData = {
        ...
        cpd_hours: Number.parseFloat(formData.cpd_hours) || 0,
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => handleInputChange("cpd_hours", e.target.value)}
                    placeholder="e.g. 2.5"
                  />
                  <p className="text-xs text-gray-500">CPD hours awarded upon course completion</p>
                </div>
              </div>
                ...
                <div className="space-y-2">
                  ...
                  <Select value={formData.course_type} onValueChange={(value) => handleInputChange("course_type", value)}>
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="PRIVATE">Private Course (Access Code)</SelectItem>
                    </SelectContent>
                  </Select>
                </div>
