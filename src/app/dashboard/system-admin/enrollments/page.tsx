...
export default function SystemAdminEnrollmentsPage() {
  ...
  const fetchAllData = async () => {
    ...
    try {
      ...
      // Fetch access code requests for private courses
    ...
    <div className="container mx-auto p-4 md:p-6 space-y-6">
        ...
        <Card>
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-gray-500">Private Course Access Code Requests</p>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
        ...
        <TabsContent value="access-code-requests">
          <Card>
            <CardHeader>
              <CardTitle>Private Course Access Code Requests</CardTitle>
              <CardDescription>
                Learners requesting access codes for private courses
              </CardDescription>
            </CardHeader>
            <CardContent>
              {loading ? (
                ...
                <div className="text-center py-8">
                  ...
                  <p className="text-gray-500">
                    When learners request access codes for private courses, they will appear here.
                  </p>
                </div>
              ) : (
