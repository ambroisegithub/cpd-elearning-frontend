...
export default function AllCoursesPage() {
  ...
  const selectClass = "w-full px-4 py-2 border border-gray-200 rounded-lg text-sm bg-background text-foreground focus:ring-2 focus:ring-ring focus:outline-none";
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          {[
            ...
            <div key={s.label} className="bg-card rounded-xl p-6 shadow-sm border border-gray-200">
          ...
          <div className="flex flex-col md:flex-row gap-4">
            <div className="flex-1 relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-3 border border-gray-200 rounded-lg bg-background text-foreground placeholder:text-muted-foreground focus:ring-2 focus:ring-ring focus:outline-none"
              />
            </div>
            <button
            ...
            <button
              ...
              className="px-6 py-3 border border-gray-200 rounded-lg hover:bg-muted transition-colors flex items-center gap-2 text-foreground"
            >
            ...
            <button
              ...
              className="px-6 py-3 border border-gray-200 rounded-lg hover:bg-muted transition-colors text-foreground"
            >
            ...
            <div className="mt-6 pt-6 border-t border-gray-200 grid grid-cols-1 md:grid-cols-4 gap-4">
              ...
              <div className="md:col-span-4 flex gap-3 justify-end">
                <button
                  ...
                  className="px-6 py-2 border border-gray-200 rounded-lg hover:bg-muted text-foreground"
                >
                  Clear Filters
                </button>
                <button
        ...
        <div className="bg-card rounded-xl shadow-sm border border-gray-200 overflow-hidden">
          {isLoading ? (
            <div className="p-12 text-center">
              <div className="inline-block animate-spin rounded-full h-12 w-12 border-4 border-primary" />
                  ...
                  <tr>
                    <th className="px-3 py-2 text-left w-10">
                      <input
                        ...
                        className="w-4 h-4 accent-primary border-gray-200 rounded"
                      />
                    </th>
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <div className="min-w-0 flex-1">
                            ...
                            <div className="flex items-center gap-2 text-xs text-muted-foreground">
                              {course.course_type === "PRIVATE" && course.institution ? (
                                <span className="inline-flex items-center gap-1 truncate">
                                  <Building2 className="w-3 h-3 flex-shrink-0" />
                                  <span className="truncate">{course.institution.name}</span>
                                </span>
                              ) : course.course_type === "PUBLIC" && course.is_public ? (
          ...
          <div className="mt-6 flex items-center justify-between">
            ...
            <div className="flex gap-2">
              <button
                ...
                className="px-4 py-2 border border-gray-200 rounded-lg hover:bg-muted text-foreground disabled:opacity-50 disabled:cursor-not-allowed"
              >
                Previous
              </button>
                ...
                <button
                  ...
                  className={`px-4 py-2 rounded-lg ${
                    pagination.page === i + 1
                      ...
                      : "border border-gray-200 hover:bg-muted text-foreground"
                  }`}
                >
                  {i + 1}
                </button>
