...
export default function CreateEditInstitutionPage() {
  ...
  useEffect(() => {
    if (isEditMode && selectedInstitution) {
      setFormData({
        ...
        require_approval_for_private: selectedInstitution.settings?.require_approval_for_private ?? false,
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const settings = {
      ...
      require_approval_for_private: formData.require_approval_for_private,
    };
            ...
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <input
                    type="checkbox"
                    checked={formData.require_approval_for_private}
                    onChange={(e) =>
                      handleChange("require_approval_for_private", e.target.checked)
                    }
                    className="w-5 h-5 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
                  />
                </div>
